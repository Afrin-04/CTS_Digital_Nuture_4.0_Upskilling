BEGIN
    EXECUTE IMMEDIATE 'DROP PACKAGE BODY CustomerManagement';
...
BEGIN
    EXECUTE IMMEDIATE 'DROP PACKAGE BODY EmployeeManagement';
EXCEPTION WHEN OTHERS THEN NULL; END;
/
...
BEGIN
    EXECUTE IMMEDIATE 'DROP PACKAGE BODY AccountOperations';
EXCEPTION WHEN OTHERS THEN NULL; END;
/
